...
struct general_settings_t {
  ...
  float ambient_light[4] = {.0f,.0f,.0f,1.f};
  bool enable_color_material = false;
  float color[4] = {.5f,.0f,.0f,1.f};
  void Apply() const;
};
...
struct light_settings_t {
	bool enable = false;
	float position[4] = { 0.f, 10.f , 2.f, 1.f };
	float ambient[4]  = {1.0f,1.0f  ,1.0f ,1.f  };
	float diffuse[4]  = {1.f ,1.0f  ,1.0f,1.f};
...
struct material_settings_t {
	...
	float diffuse[4]  = {0.f ,1.f ,0.f ,1.f};
	float specular[4] = {0.f ,0.f ,1.f,1.f};
	int shininess = 127;
  void Apply() const;
};
